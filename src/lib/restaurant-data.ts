 ...
 * - `defaultRestaurantData` is the Amigos Hub seed — the live site is pixel-identical
...
export type RestaurantData = {
  ...
  heroCollagePhotos: [string, string, string]; // 3 collage photo URLs
  heroCollageAlts: [string, string, string];
  ...
  // ── CMS lock ──────────────────────────────────────────────────────────────
  /**
   * When true, the /dashboard-x7k2 route returns 404 even with the correct password.
   * To unlock after selling: edit data/restaurant.json directly and set "isLocked": false,
   * OR delete data/restaurant.json entirely to reset to seed defaults (isLocked: false).
   */
  isLocked: boolean;

  // ── CMS metadata ──────────────────────────────────────────────────────────
  /**
   * Tracks which sections were auto-generated by the Quick Demo tool.
   * Useful to flag them in the detailed CMS as needing manual review/editing.
   */
  autoGeneratedFields?: string[];
};

// ─── Seed defaults (Amigos Hub) ───────────────────────────────────────────────

export const defaultRestaurantData: RestaurantData = {
  // Identity
  name: "Amigos Hub",
  tagline: "Satya Niketan's loudest, friendliest cafe since 2014",
  logoUrl: "/logo.avif",
  ...
  // Contact
  address:
    "96, 1st, Satya Niketan, opposite Venkateshwar college, Moti Bagh II, Satya Niketan, South Moti Bagh, New Delhi, Delhi, 110021",
  addressShort:
    "96, 1st, Satya Niketan, opposite Venkateshwar college\nMoti Bagh II, New Delhi, Delhi 110021",
  phone: "+91 99997 39766",
  whatsappNumber: "919999739766",
  hours: "10:00 am – 10:30 pm every day",
  hoursShort: "Open daily · 10 AM – 10:30 PM",
  priceRange: "Approx ₹400–900 for two · cards & UPI accepted",

  // Social
  socialLinks: {
    instagram: "https://www.instagram.com/amigoshub.india/",
    maps: "https://maps.app.goo.gl/FF8mphjaHEt2PKtC7",
  },
  mapsEmbedQuery: "Amigos+Hub+Satya+Niketan",

  // Hero
  heroLocationBadge: "Satya Niketan · open till 10:30 PM",
  heroHeadline: ["Loud music.", "Cheesy burgers.", "Tiny tables."],
  heroHeadlineSince: "since 2014",
  heroSubcopy:
  ...
  heroCollagePhotos: ["/photos/3.webp", "/photos/2.webp", "/photos/1.webp"],
  heroCollageAlts: [
    "Cafe interior with yellow striped counter",
    "Brightly lit seating area decorated with red balloons",
    "Dimly lit cafe full of people dining",
  ],
  heroCollageAnnotation: "↑ packed house every weekend",
  ...
  // Story teaser
  storyTeaserPhoto: "/photos/4.webp",
  storyTeaserPhotoAlt:
    "Amigos Hub cafe interior with hanging plants and warm Edison bulbs",
  storyTeaserScriptLabel: "our whole thing →",
  storyTeaserPrefix: "Eleven years of",
  storyTeaserH2: ["fairy lights", "first-year crushes"],
  storyTeaserBody:
  ...
  milestones: [
    {
      year: "2014",
      title: "Three tables and a speaker",
      body: "Amigos Hub opened on a quiet first floor across from Sri Venkateshwara College. Three tables, one playlist, and a menu small enough to memorise.",
    },
    {
      year: "2016",
      title: "The wishes wall begins",
      body: "A regular stuck a sticky note by the door. Then another. Then a hundred. The wall has not had an empty patch since.",
    },
    {
      year: "2018",
      title: "Featured in Delhi Times",
      body: "Suddenly the queue outside started spilling into the staircase. We added the second long table.",
    },
    {
      year: "2020",
      title: "We made it through",
      body: "Quietly delivered cheesy garlic bread and KitKat shakes to locked-down hostels and PGs across South Campus.",
    },
    {
      year: "2023",
      title: "So Delhi feature",
      body: "Called us 'a budget date night institution'. We printed it out and stuck it on the wall.",
    },
    {
      year: "Today",
      title: "11+ years, still loud",
      body: "Same fairy lights, more plants, slightly better coffee. Still pocket-friendly. Still your spot.",
    },
  ],
  stats: [
  ...
  pressQuote: "A budget date-night institution.",
  pressAttribution: "As featured in Delhi Times & So Delhi.",
  ...
  galleryPhotos: [
    { src: "/photos/ai_interior.png", cat: "ambience", caption: "Friday night, full house" },
    { src: "/photos/ai_crowd.png", cat: "ambience", caption: "The long table" },
    { src: "/photos/ai_yellow_stripe.png", cat: "ambience", caption: "Our yellow striped corner" },
    { src: "/photos/ai_sticky_wall.png", cat: "ambience", caption: "The wishes wall" },
    { src: "/photos/ai_art_wall.png", cat: "ambience", caption: "Hanging plant + framed art" },
    { src: "/photos/ai_balloons.png", cat: "ambience", caption: "Birthday balloon setup" },
    { src: "/photos/ai_interior.png", cat: "ambience", caption: "Edison bulbs at dinner" },
    { src: "/photos/ai_interior.png", cat: "ambience", caption: "Quiet afternoon shift" },
    { src: "/photos/ai_mojito.png", cat: "drinks", caption: "Watermelon mojito" },
    { src: "/photos/ai_drink_pink.png", cat: "drinks", caption: "Cranberry cooler" },
  ],

  // Footer
  footerTagline: "since 2014",
  footerBody:
    "A tiny, loud, plant-strung corner of Satya Niketan that has been feeding DU South Campus on a student budget for over a decade.",
  ...
  seoMeta: {
    home: {
      ...
      description:
        "Burgers, shakes, mojitos & momos in Satya Niketan since 2014. Graffiti walls, fairy lights, pocket-friendly menus, and the DU South Campus crowd.",
      ogImage: "/photos/ai_crowd.png",
    },
    menu: {
      title: "Menu · Amigos Hub Satya Niketan",
      description:
        "Burgers, pizza, pasta, momos, shakes, mojitos, shawarma & coffee — the full Amigos Hub menu. Pocket-friendly comfort food from DU South Campus's favourite cafe since 2014.",
      ogImage: "/photos/ai_drink_pink.png",
    },
    about: {
      title: "About · Amigos Hub · A Satya Niketan Original Since 2014",
      description:
        "Eleven years of feeding DU South Campus on a student budget. The story of a tiny first-floor cafe in Satya Niketan that became everyone's third place.",
      ogImage: "/photos/ai_interior.png",
    },
    contact: {
      title: "Contact & Reservations · Amigos Hub Satya Niketan",
      description:
        "Find Amigos Hub in Satya Niketan, opposite Sri Venkateshwara College. Call us, book a table, or plan a budget birthday.",
      ogImage: "/photos/ai_interior.png",
    },
    gallery: {
      title: "Gallery · Amigos Hub Cafe Satya Niketan",
      description:
        "Real photos of Amigos Hub — the graffiti walls, fairy lights, sticky-note wishes wall, our food, our drinks, and the crowd that makes it all happen.",
      ogImage: "/photos/ai_sticky_wall.png",
    },
  },
...
export function getGoogleMapsEmbedUrl(queryOrUrl?: string): string {
  if (!queryOrUrl || !queryOrUrl.trim()) {
    return "https://www.google.com/maps?q=Amigos+Hub+Satya+Niketan&output=embed";
  }
